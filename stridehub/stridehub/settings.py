"""
Django settings for stridehub project.
...
SECRET_KEY = 'django-insecure-8%_efp(mw7#xp_u2y#q_cev*3ly4nd2ciop^r488uqf70+wgpg'
...
WSGI_APPLICATION = 'stridehub.wsgi.application'
